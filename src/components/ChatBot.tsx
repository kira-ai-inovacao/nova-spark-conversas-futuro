        ...
        <div className="flex items-center justify-between max-w-4xl mx-auto">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Polo de Inovação Tecnológica</p>
            </div>
          </div>
          <Button
            variant="ghost"
          ...
          {messages.map((message) => (
            ...
            >
              <div className={`max-w-xs lg:max-w-md xl:max-w-lg flex items-start space-x-3 ${message.isBot ? '' : 'flex-row-reverse space-x-reverse'}`}>
                ...
                <div className={`glass-morphism rounded-2xl p-3 border ${
                  message.isBot 
                    ? 'border-neon-blue/30 bg-blue-900/20' 
                    : 'border-neon-cyan/30 bg-cyan-900/20'
                }`}>
